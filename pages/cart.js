...
function cartScreen() {
    ...
    return (
       <Layout title="Shopping Cart" >
            ...
            {cartItems.length === 0 ? (
                <div>Cart is empty. <NextLink href="/">Go shopping!</NextLink> </div>
            ): (
                                    ...
                                    {cartItems.map((item) => (
                                        <TableRow key={item._id} >
                                                ...
                                                <TableCell align="right">
                                                    ...
                                                    >
                                                        {[...Array(item.countInStock).keys()].map((x) => ( <MenuItem key={x+1} value={x+1}>
                                                                    {x + 1}
                                                        </MenuItem>
                                                         ))}
                                                    </Select>
                    ...
                    <Grid item md={3} xs={12} >
                        <Card>
                            <List>
                                ...
                                <ListItem>
                                    <Button variant="contained" color="primary" onClick={checkoutHandler} > Checkout now </Button>
                                </ListItem>
                            </List>
                        </Card>
                    </Grid>
